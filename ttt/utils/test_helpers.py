...
def test_nm(teloader, model, ckpt, verbose=False, print_freq=10):
    ...
    for i, (inputs, labels) in enumerate(teloader):
        with torch.no_grad():
            ...
            # print(one_hot, predicted, labels)
            # print('predicted', predicted)
            # if (3 not in labels):
            #     if (1 in predicted and 0 in predicted):
            #         print('Made predictions of 1 and 0!!!!!')
            #         print('predicted:', predicted)
            #         print('labels:', labels)
